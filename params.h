...
#define N 320 // the degree of the modulos polynomial, X^N+1
#define Q 641 // the modulos
#define ROOT_OF_UNITY 21 // the PRIMITIVE_N th root of unity
#define PRIMITIVE_N 128 //to what power the root of unity is 1
#define LEVEL 6 // how many levels that will be performed
#define INNVERSE_POWER_OF_TWO 631// the inverse of 2^LEVEL he
